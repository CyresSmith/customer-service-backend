...
export class AddServiceCategory1709203410869 implements MigrationInterface {
    name = 'AddServiceCategory1709203410869'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "Service" DROP CONSTRAINT "FK_67f107076d6bd8d3925d4c11064"`);
        await queryRunner.query(`CREATE TABLE "serviceCategory" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "companyId" integer, CONSTRAINT "PK_4d1e379dec18d0571ca6346e7fa" PRIMARY KEY ("id"))`);
